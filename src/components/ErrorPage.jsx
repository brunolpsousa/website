...
export default function ErrorPage() {
  ...
  return (
    <div className='pt-20' onLoad={returnToIndex()}>
      <div className='flex items-center justify-center flex-col text-center my-40 pb-6'>
        <p className='text-base md:text-4xl text-stone-600 dark:text-stone-100 mb-3 font-medium'>
          Desculpe, não foi possível carregar esta página
        </p>
        <Link to={'/'}>
          <button
            id='ReturnButton'
